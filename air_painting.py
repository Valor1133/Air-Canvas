...
lower_bound = np.array([25, 80, 200])
upper_bound = np.array([45, 230, 255])

# these are the rangers for the holder.
hold_low = np.array([100, 100, 140])
hold_up = np.array([120, 145, 180])
hold = False
...
while cap.isOpened():
    ...
    paint = cv2.putText(paint, 'AIR CANVAS', (40, 640), font2, 1, (204, 0, 0), 2)
